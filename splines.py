...
class CubicSpline:
    # Initialize.
    def __init__(self, p0, v0, pf, vf, T, space='Joint', leg=0):
...
class QuinticSpline:
    # Initialize.
    def __init__(self, p0, v0, a0, pf, vf, af, T, space='Joint', leg=0):
